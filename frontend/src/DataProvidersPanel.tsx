...
export default function DataProvidersPanel({ token, isAdmin }: DataProvidersPanelProps) {
  ...
  const statusLabel: Record<DataProviderHealth["status"], string> = { healthy: "健康", demo: "演示", degraded: "数据偏旧", timeout: "超时", error: "异常", unavailable: "不可用" };
