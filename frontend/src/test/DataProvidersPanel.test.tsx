...
describe("管理员数据源健康面板", () => {
  it("展示探测状态、延迟和快照年龄", async () => {
    vi.stubGlobal("fetch", vi.fn()
      ...
      { name: "old", kind: "测试", description: "旧快照", configured: false, status: "degraded", latency_ms: 8, snapshot_as_of: "2026-09-02T01:00:00Z", snapshot_age_seconds: 3600, snapshot_max_age_seconds: 1800, source: "old", message: "快照已延迟 3600 秒，超过 1800 秒阈值", checked_at: "2026-09-02T02:00:00Z" },
      ]), { status: 200 }))
      .mockResolvedValueOnce(new Response(JSON.stringify([
    ...
    expect(screen.getByText("old · 数据偏旧")).toBeTruthy();
